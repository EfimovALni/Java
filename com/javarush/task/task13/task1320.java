...
import static com.javarush.task.task13.task1320.Solution.Matrix.NEO;

public class Solution {
    public static void main(String[] args) throws Exception {
        System.out.println(Matrix.NEO); // С названием класса Matrix - долго парился, допереть не мог....
    }
